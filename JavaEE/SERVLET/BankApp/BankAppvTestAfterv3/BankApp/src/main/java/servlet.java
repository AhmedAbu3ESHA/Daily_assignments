...
Trans obj=null;
    ...
    private void add(HttpServletRequest request, HttpServletResponse response,String phone ){
        double amount = Double.parseDouble(request.getParameter("amount"));
        int year = Integer.parseInt(request.getParameter("year"));
        int percent = Integer.parseInt(request.getParameter("percentage"));
        double interest = (amount * year * percent) / 100;
    ...
    private Trans make(HttpServletRequest request, HttpServletResponse response) {
        logged = true;
        double amount=0;
        int year=0;
        int percent=0 ;
