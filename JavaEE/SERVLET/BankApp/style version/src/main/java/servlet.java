...
public class servlet extends HttpServlet {
    ...
    private static void loan(HttpServletRequest request) {
        ...
        request.setAttribute("interest_paid", interestPaid);
...
//                double Monthly_Interest_Rate = Rate / 12;
        ...
        double Monthly_Installments =finalAmount/Number_of_Months;


        request.setAttribute("Installments",Math.round(Monthly_Installments));
    }
