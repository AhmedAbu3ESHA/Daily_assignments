...
public class Tran {
    ...
    public Tran(double principleAmount, double rate, int loanYears, double monthlyInstallments, double finalAmount) {
    ...
    public Tran(double amount, int year, int percent, double balance, String phone) {
        this.amount = amount;
        this.year = year;
    ...
    public Tran(double amount, int year, int percent, double balance, String phone, int yearpayback) {
        this.amount = amount;
        this.year = year;
        this.percent = percent;
        this.balance = balance;
    ...
    public Tran(double amount, int year, int percent, String phone, int npv, String npvState) {
        this.amount = amount;
        this.year = year;
        this.percent = percent;
        this.phone = phone;
