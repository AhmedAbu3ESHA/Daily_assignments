...
public class Trans {
    ...
    List<Trans> transactionlog;
    List<Trans> transYear;
    List<Trans> transPercent;

    public Trans(List<Trans> transaction, List<Trans> transactionlog, List<Trans> transYear, List<Trans> transPercent, double amount, int year, int percent, String phone, int yearpayback, double balance) {
    ...
    public List<Trans> getTransactionlog() {
        return transactionlog;
    }

    public void setTransactionlog(List<Trans> transactionlog) {
        this.transactionlog = transactionlog;
    }
    ...
    public void setTransaction(List<Trans> transaction) {
        this.transaction = transaction;
    }

    public List<Trans> getTransYear() {
        return transYear;
    }

    public void setTransYear(List<Trans> transYear) {
        this.transYear = transYear;
    }

    public List<Trans> getTransPercent() {
        return transPercent;
    }

    public void setTransPercent(List<Trans> transPercent) {
        this.transPercent = transPercent;
    }
