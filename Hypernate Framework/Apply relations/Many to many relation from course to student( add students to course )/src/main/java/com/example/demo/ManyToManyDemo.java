...
public class ManyToManyDemo {
	public static void main(String[] args) {
		...
		// do my action on db from  student table to course table
//		//creat student
//
...
//
		...
		// do my action on db from course table   to student table
	...
	//creat student
     Student st=new Student("omar","ali","oa@yahoo.com");
