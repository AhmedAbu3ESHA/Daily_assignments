...
// creating new account
                            ...
                            // Accounts Holder Data Editing
                                ...
                                try (Connection con3 = DriverManager.getConnection("jdbc:mysql://localhost/banktps", "root", "root123");
                                     PreparedStatement st4 = con3.prepareStatement("SELECT sum(TransAmount)  as sum  FROM transactions WHERE AccNum = ? AND TransDate BETWEEN ? AND ? AND TransType like 'd%' AND TransStatus = 1 ")) {
                            ...
                            //add 10% for your account ballance mouncely
                                ...
                                //add 10% for balance
                                try (Connection con3 = DriverManager.getConnection("jdbc:mysql://localhost/banktps", "root", "root123");
                                     PreparedStatement st4 = con3.prepareStatement("UPDATE account SET Balance =Balance+(((InitialBalance*10)/100)/2) where AccNum =? AND AccType=?")) {
