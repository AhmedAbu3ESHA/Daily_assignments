                                            ...
                                            if (transactionType.equalsIgnoreCase("credit")||transactionType.equalsIgnoreCase("cr")) {
                                                ...
                                                try (PreparedStatement preparedStatement = con.prepareStatement(sql4)) {
                                                    ...
                                                    if (amount > 0) {
                                                        ...
                                                        try (Connection con2 = DriverManager.getConnection("jdbc:mysql://localhost/banktps", "root", "root123");
                                                             PreparedStatement st2 = con2.prepareStatement("UPDATE account SET BalanceStatus = ? where AccNum=? ")) {
...
///debit transaction
                                                ...
                                                try (PreparedStatement preparedStatement = con.prepareStatement(sql4)) {
                                                    ...
                                                    if (amount > 0 && amount <= accbalance) {
                                                        ...
                                                        try (Connection con2 = DriverManager.getConnection("jdbc:mysql://localhost/banktps", "root", "root123");
                                                             PreparedStatement st2 = con2.prepareStatement("UPDATE account SET BalanceStatus = ? where AccNum=? AND Balance <= ?*0.5 ")) {
...
// creating new account
                                ...
                                try (
                                        ...
                                        PreparedStatement st2 = con2.prepareStatement("INSERT INTO account (AccNum, AccHolderSSN,BranchName, Balance, AccHolderFname, AccHolderLname, AccEmail, Street,City,EmpCode,AccType,InitialBalance) VALUES (?,?, ?, ?, ?, ?, ?, ?, ?, ?,?.?)")
                                ) {
                                    ...
                                    st2.setDouble(12,initialbalance);
                                    st2.executeUpdate();
                            ...
                            // Accounts Holder Data Editing
                                ...
                                try (Connection con3 = DriverManager.getConnection("jdbc:mysql://localhost/banktps", "root", "root123");
                                     PreparedStatement st4 = con3.prepareStatement("SELECT SUM(TransAmount) as sum FROM transactions WHERE AccNum = ? AND TransDate BETWEEN ? AND ? AND TransType like 'c%' AND TransStatus = 1 ")) {
                                ...
                                //startbalance
                                double startball=  20000-(cre-deb);
                                System.out.println(acBalance);
                                ...
                                try (Connection con3 = DriverManager.getConnection("jdbc:mysql://localhost/banktps", "root", "root123");
                                     PreparedStatement st4 = con3.prepareStatement("SELECT sum(TransAmount) as sum  FROM transactions WHERE AccNum = ? AND TransDate > ? AND TransDate <= ? AND TransType like 'c%' AND TransStatus = 1 ")) {
                                    st4.setInt(1, accountNumber);
                                ...
                                try (Connection con3 = DriverManager.getConnection("jdbc:mysql://localhost/banktps", "root", "root123");
                                     PreparedStatement st4 = con3.prepareStatement("SELECT sum(TransAmount)  as sum  FROM transactions WHERE AccNum = ? AND TransDate > ? AND TransDate <= ?  AND TransType like 'd%' AND TransStatus = 1 ")) {
                                ...
                                double lastbalance = 20000-(cr-dr);
                            ...
                            //add 10% for your account ballance mouncely
                                ...
                                //add 10% for balance
                                try (Connection con3 = DriverManager.getConnection("jdbc:mysql://localhost/banktps", "root", "root123");
                                     PreparedStatement st4 = con3.prepareStatement("UPDATE account SET Balance =Balance+InitialBalance*0.1 where AccNum =? AND AccType='saving'")) {
